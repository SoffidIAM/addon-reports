...
public class SoffidDataAdapterDescriptor extends DataAdapterDescriptor
	...
	public DataAdapter getDataAdapter() {
		if (dataAdapter == null)
			dataAdapter = new SoffidDataAdapterImpl();
		return dataAdapter;
	}
	...
	public DataAdapterEditor getEditor() {
		...
		return new SoffidDataAdapterEditor();
	}
	...
	public Image getIcon(int size) {
		if (size == 16) {
			return Activator.getDefault().getImage("icons/soffid.png");
		}
		return null;
	}
	...
	public void getFieldProvider() {
		if (fprovider == null)
			fprovider = new SoffidFieldsProvider();
	}
	...
	public AWizardDataEditorComposite createDataEditorComposite(Composite parent, WizardPage page) {
		return new WizardQueryEditorComposite(parent, page, this, "hql");
	}

	@Override
	public String[] getLanguages() {
		return new String[] { "hql", "sql", "bsh" };
	}
