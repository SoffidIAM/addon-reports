 ...
 */
public class SoffidDataAdapterServiceExtensionsRegistryFactory implements ExtensionsRegistryFactory
{
	private static final ExtensionsRegistry extensionsRegistry = 
			new SingletonExtensionRegistry<DataAdapterContributorFactory>(
					DataAdapterContributorFactory.class, SoffidDataAdapterServiceFactory.getInstance());
