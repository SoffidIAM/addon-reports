...
public class Activator extends AbstractJRUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.soffid.iam.addon.report.jasper"; //$NON-NLS-1$
	 ...
	 */
	public Activator() {
		System.out.println("Created SOFFID Bundle");
	}
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		System.out.println("Started SOFFID Bundle");
	}
