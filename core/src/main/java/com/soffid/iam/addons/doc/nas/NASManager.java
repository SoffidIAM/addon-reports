package com.soffid.iam.addons.doc.nas;
...
import com.soffid.iam.addons.doc.model.DocSignDao;
import com.soffid.iam.addons.doc.model.DocumentEntity;
import com.soffid.iam.addons.doc.model.DocumentEntityDao;
import com.soffid.iam.addons.doc.model.FileSystemDao;
import com.soffid.iam.addons.doc.nas.comm.CIFSStrategy;
import com.soffid.iam.addons.doc.nas.comm.FTPStrategy;
import com.soffid.iam.addons.doc.nas.sign.CAIBStrategy;
	...
	*/
		...
		IllegalAccessException, ClassNotFoundException, NASException
	{
		...
		if (docStrategy.startsWith("es.caib.bpm.nas.comm."))
			docStrategy = "com.soffid.iam.addons.doc.nas.comm" + docStrategy.substring(docStrategy.lastIndexOf('.'));
